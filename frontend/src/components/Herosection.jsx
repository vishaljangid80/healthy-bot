...
const Herosection = () => {
  return (
    <section id="home" className="px-7 sm:px-20">
      <div className="container lg:flex mt-10 p-8 items-start">
        <div className="home-content lg:px-32 px-10 lg:mt-14 sm:w-full">
          ...
          <p className="text-white text-xl mb-8">
            Your health is our top priority. At VarunCare, we offer premium
        ...
        <div className="home-image mt-8 lg:mt-0">
          <img src={homepage} alt="Doctor" className="w-full scale-125 lg:max-w-xl" />
        </div>
      </div>
    </section>
  );
